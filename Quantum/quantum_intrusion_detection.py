...
# ==================================================================
def load_nslkdd_dataset(train_filepath, test_filepath, test_size=0.2, max_samples=10000, n_features=10):
...
def load_nslkdd_simple(csv_filepath, test_size=0.2, max_samples=10000, n_features=10):
...
def main():
    ...
    print("   NSL-KDD Dataset (Limited to 10000 Training Samples)")
    print("="*70)
    ...
    try:
        ...
        if choice == '1':
            X_train, X_test, y_train, y_test, feature_names, df = load_nslkdd_dataset(
                train_file, test_file, max_samples=10000
            )
        else:
            X_train, X_test, y_train, y_test, feature_names, df = load_nslkdd_simple(
                train_file, max_samples=10000
            )
